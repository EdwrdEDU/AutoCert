...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Certificate Generator'); ?></title>
    ...
    <footer class="bg-white border-t mt-auto relative">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <p class="text-center text-gray-500 text-sm">
                Certificate Generator &copy; <?php echo e(date('Y')); ?> | Built with Laravel
            </p>
        </div>
    </footer>
...
<?php /**PATH C:\Users\Edwrd\Desktop\HRCert\resources\views/layouts/app.blade.php ENDPATH**/ ?>