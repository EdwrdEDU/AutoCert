...
<div class="mb-6 flex justify-between items-center min-w-[800px]">
    <h2 class="text-3xl font-bold text-gray-900">Generated Certificates</h2>
</div>

<?php if($certificates->isEmpty()): ?>
    <div class="bg-white rounded-lg shadow-md p-12 text-center min-w-[800px]">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-medium text-gray-900">
                                <?php echo e($certificate->recipient_name ?? 'N/A'); ?>

                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900"><?php echo e($certificate->template->name); ?></div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            <?php echo e($certificate->generated_at ? $certificate->generated_at->format('M d, Y H:i') : '-'); ?>

                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end gap-2">
                                <a href="<?php echo e(route('certificates.show', $certificate)); ?>" class="text-indigo-600 hover:text-indigo-900">View</a>
                                <button @click="deleteId = <?php echo e($certificate->id); ?>" type="button" class="text-red-600 hover:text-red-900">Delete</button>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="bg-white rounded-lg shadow-xl p-6 max-w-sm w-full mx-4">
                ...
                <div class="flex gap-3">
                    ...
                    <template x-if="deleteId">
                        <form :action="'<?php echo e(url('/certificates')); ?>/' + deleteId" 
                              method="POST" 
                              class="flex-1">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
                            <button type="submit" 
                                    class="w-full px-4 py-2 text-white bg-red-600 hover:bg-red-700 rounded-lg font-medium transition">
                                Delete
                            </button>
                        </form>
                    </template>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Edwrd\Desktop\HRCert\resources\views/certificates/index.blade.php ENDPATH**/ ?>